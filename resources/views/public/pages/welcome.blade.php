                    ...
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-120 p-b-50 respon5">
                            ...
                            <div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
                                <a href="{{ route('service') }}" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-25 p-tb-10 trans-04" style="font-size: 1.1rem;">
                                    Lihat Layanan
                                </a>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 p-b-30">
                    <div class="block1 wrap-pic-w position-relative rounded overflow-hidden shadow-sm transition-all hover-shadow">
                        <img src="assets/images/ui.jpg" alt="UI/UX Design" class="img-fluid transition-all hover-zoom" style="height: 280px; object-fit: cover; width: 100%;">
                        
                        <a href="{{ route('service') }}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3 bg-overlay-50">
                ...
                <div class="col-md-6 col-lg-4 p-b-30">
                    <div class="block1 wrap-pic-w position-relative rounded overflow-hidden shadow-sm transition-all hover-shadow">
                        <img src="assets/images/googlecloud.jpg" alt="Google Cloud" class="img-fluid transition-all hover-zoom" style="height: 280px; object-fit: cover; width: 100%;">
                ...
                <div class="col-md-6 col-lg-4 p-b-30">
                    <div class="block1 wrap-pic-w position-relative rounded overflow-hidden shadow-sm transition-all hover-shadow">
                        <img src="assets/images/sentimen.jpg" alt="Analisis Sentimen" class="img-fluid transition-all hover-zoom" style="height: 280px; object-fit: cover; width: 100%;">
    ...
    <section class="bg0 p-t-60 p-b-90">
        <div class="container">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35">
                    <div class="block2 shadow-sm rounded overflow-hidden hover-shadow transition-all h-100">
                        <div class="block2-pic hov-img0 position-relative">
                            <img src="{{ asset('storage/' . $jasa->gambar) }}" alt="{{ $jasa->nama }}" class="img-fluid w-100" style="height: 220px; object-fit: cover;">
                            
                            <div class="price-tag position-absolute" style="top: 10px; right: 10px; background-color: rgba(0,0,0,0.7); padding: 5px 10px; border-radius: 20px;">
                                <span class="stext-105 cl0">
                                    Rp{{ number_format($jasa->harga, 0, ',', '.') }}
                                </span>
                            </div>

                            <a href="{{ route('detail-service', $jasa->id) }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                                Detail Layanan
                            </a>
                        </div>
                        ...
                        <div class="block2-txt p-4">
                            <div class="block2-txt-child1 mb-2">
                                <a href="{{ route('detail-service', $jasa->id) }}" class="text-dark text-decoration-none">
            ...
            <div class="flex-c-m flex-w w-full p-t-45">
                <a href="{{ route('service') }}" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
                    Lihat Semua Layanan
                </a>
            </div>
        </div>
