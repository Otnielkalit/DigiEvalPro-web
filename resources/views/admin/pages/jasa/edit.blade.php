            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="nama" name="nama" value="Jasa Digital Marketing">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="harga" class="form-label">Harga</label>
                        <input class="form-control" type="number" id="harga" name="harga" value="500000">
                    </div>
                </div>

                <div class="mb-3">
                    <label for="deskripsi" class="form-label">Deskripsi</label>
                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4">Layanan digital marketing profesional untuk bisnis Anda.</textarea>
                </div>
